...
import { TESTIMONIALS } from "@/src/features/marketing/data";
  ...
  return (
    <Section className="bg-white" id="stories">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {TESTIMONIALS.map(({ key, avatar }, i) => (
          <Reveal key={key} delay={i * 80} className="h-full">
            <div className="flex h-full flex-col gap-4 rounded-2xl bg-white p-6 shadow-soft motion-safe:transition-all motion-safe:duration-300 motion-safe:hover:-translate-y-1.5 motion-safe:hover:shadow-lift">
