  ...
  return (
    <StudentAppShell user={user} active="discover">
      <div className="mx-auto max-w-[1400px] px-4 py-8 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <h1 className="flex items-center gap-3 text-5xl font-black tracking-tight text-ink sm:text-6xl dark:text-slate-50"><Search className="size-10 text-brand-600 dark:text-brand-300" /><MarkerHighlight color="yellow" variant={1}>اكتشف ما يناسبك</MarkerHighlight></h1>
