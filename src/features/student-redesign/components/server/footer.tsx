          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-black tracking-tight text-white font-cairo">
                علمني{" "}
                <span className="text-primary font-bold text-xs bg-primary/20 px-2 py-0.5 rounded-md border border-primary/40">
                  ELEMNI
                </span>
              </span>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed max-w-md font-normal">
              منصة علمني هي البوابة التعليمية الذكية الأولى الرائدة للدروس
              المباشرة التفاعلية، بنوك الأسئلة، وكورسات المعلمين الشاملة لطلاب
              الثانوية العامة والصفوف الدراسية.
            </p>
            <div className="pt-2 flex items-center gap-3 text-slate-400">
              <a
                href="#"
                className="w-9 h-9 rounded-xl bg-slate-800/80 flex items-center justify-center hover:bg-primary hover:text-white transition-all"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
