    ...
    <section id="pricing" className="py-20 bg-[#F8FAFC] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#0F172A] tracking-tight font-cairo">
            ...
            >
              ...
              <div>
                ...
                <div className="mb-6 p-4 bg-[#F8FAFC] rounded-2xl border border-slate-100 flex items-baseline justify-between">
                  ...
                  {plan.discount && (
                    <span className="text-xs font-bold text-[#22C55E] bg-[#22C55E]/10 px-2.5 py-1 rounded-lg border border-[#22C55E]/20">
                      {plan.discount}
                    </span>
                  )}
                </div>
              ...
              <button
                ...
                className={`w-full py-4 text-sm font-extrabold rounded-2xl transition-all cursor-pointer shadow-md font-cairo text-center ${
                  plan.featured
                    ? 'bg-primary hover:bg-primary-hover text-white shadow-primary/30'
                    : 'bg-slate-100 hover:bg-primary-light text-[#0F172A] hover:text-primary'
                }`}
              >
                {plan.ctaText}
              </button>
