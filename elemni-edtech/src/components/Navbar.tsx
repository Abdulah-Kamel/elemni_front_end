    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between dir-rtl">
          ...
          {/* RIGHT SIDE (RTL): Search + Sign In + Sign Up CTA */}
          <div className="flex items-center gap-3 sm:gap-5">
            
            {/* 1. Sign Up Button ("اعمل حساب جديد !") */}
            <button
          ...
          {/* LEFT SIDE (RTL): Brand Logo & Theme Capsule Switch */}
          <div className="flex items-center gap-3 sm:gap-4">
            
            {/* Theme Toggle Capsule Switch (Sun / Moon) */}
            <button
              type="button"
              onClick={onToggleDarkMode}
              className={`relative flex items-center justify-between w-16 h-8 px-1.5 rounded-full border transition-all cursor-pointer ${
                isDarkMode
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="sm:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-4 pt-3 pb-6 space-y-3 shadow-xl mt-3 dir-rtl">
