      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-3 max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-[#0F172A] font-cairo">
            ماذا يقول أوائل الطلاب عن علمني؟
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.id}
              className="bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 flex flex-col justify-between relative"
            >
              ...
              <div>
                ...
                {/* Comment */}
                <p className="text-sm text-[#334155] leading-relaxed font-medium mb-6 text-right relative z-10">
                  "{t.comment}"
                </p>
              </div>
