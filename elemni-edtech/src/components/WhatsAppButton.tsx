...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex items-center gap-3 dir-rtl pointer-events-auto">
      {/* Tooltip Badge */}
      <div
        className={`bg-[#0F172A] text-white text-xs font-bold px-3.5 py-2 rounded-xl shadow-xl transition-all duration-300 pointer-events-none hidden sm:flex items-center gap-2 border border-slate-700 ${
