            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all overflow-hidden ${
                  isOpen
                    ? 'border-primary bg-[#F8FAFC] shadow-sm'
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`w-8 h-8 rounded-full bg-primary-light text-primary flex items-center justify-center shrink-0 transition-transform duration-300 ${
